...
/** MEMORY */
#define KR_MELTDOWN_CODE_PHYSMEMMGMT_INIT_FAILURE (KR_CATEGORY_MELTDOWN_CODE_MEMORY +    1)
#define KR_MELTDOWN_CODE_PHYSMEMMGMT_TEST_FAILURE (KR_CATEGORY_MELTDOWN_CODE_MEMORY +    2)
