...
#define KRDWTP_FOREGROUND        KRDWTP_MAKE_COLOR(0xFF,0xFF,0xFF,0xFF)
...
#define KRDWTP_COLOR_ORANGE      KRDWTP_MAKE_COLOR(0xFF,0x80,0x00,0xFF)

#define KRDWTP_COLOR_DARK_RED    KRDWTP_MAKE_COLOR(0x80,0x00,0x00,0xFF)
#define KRDWTP_COLOR_DARK_GREEN  KRDWTP_MAKE_COLOR(0x00,0x80,0x00,0xFF)
#define KRDWTP_COLOR_DARK_PURPLE KRDWTP_MAKE_COLOR(0x4B,0x00,0x6E,0xFF)
